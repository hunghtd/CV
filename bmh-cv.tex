...
\begin{cvlist}
\item 2014. Hill, Benjamin Mako and Aaron Shaw. “Consider the Redirect: A Missing Dimension of Wikipedia Research.” In \emph{Proceedings of the 10th International Symposium on Open Collaboration (OpenSym 2014)}. ACM Press.
...
\begin{cvlist}
\item 2014. Shaw, Aaron, Haoqi Zhang, Andrés Monroy-Hernández, Sean Munson, Benjamin Mako Hill, Elizabeth Gerber, Peter Kinnaird, and Patrick Minder. Computer Supported Collective Action. \emph{Interactions} 21, no. 2 74–77. IEEE.
\item 2013. Buechley, Leah, Jennifer Jacobs, Benjamin Mako Hill. Lilypad in the Wild: Technology DIY, E-Textiles, and Gender. In \emph{Textile Messages: Dispatches from the World of E-Textiles and Education}, edited by Leah Buechley, Kylie Peppler, Michael Eisenberg, and Yasmin Kafai. Peter Lang. (Expanded version of the 2010 article.)
...
\subsection{Courses}
\begin{cvlist}
\item 2014, Fall. Interpersonal Media (COM482A). UW Department of Communication.% Evening Degree Program.
